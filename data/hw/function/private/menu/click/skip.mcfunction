...
execute as @n[type=interaction,distance=..1,tag=hw_menu_skip] at @s as @n[type=text_display,distance=..0.2] run data modify entity @s default_background set value 1b
