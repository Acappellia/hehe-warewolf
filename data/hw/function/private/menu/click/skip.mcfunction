...
execute if score #game_status hw matches 20 if score #witch_night_status hw matches 0 run return run function hw:private/menu/witch_click/s1_skip
execute if score #game_status hw matches 20 if score #witch_night_status hw matches 1 run return run function hw:private/menu/witch_click/s2_skip