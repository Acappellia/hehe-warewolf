...
execute if entity @s[tag=civilian] run title @s actionbar [{"text": "你的职业：","color": "white"},{"text": "船员","color": "gray"}]
execute if entity @s[tag=warewolf] run title @s actionbar [{"text": "你的职业：","color": "white"},{"text": "狼人","color": "red"},{"text": " 你的队友：","color": "white"},{"selector": "@a[tag=warewolf,distance=0.1..]","color": "red","separator": " "}]